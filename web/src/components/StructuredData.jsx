...
import { BRAND, CONTACT, SUBJECTS, FAQS, BOOKING_RESERVE_URL } from "../data/site";
...
/* Se inyecta una sola vez y se reutiliza el mismo nodo: el grafo describe al
   negocio, no a la página, así que no cambia al navegar. */
